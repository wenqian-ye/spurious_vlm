...
if __name__ == '__main__':
    ...
    label_emb = get_text_embedding(labels_text, text_encoder)
    ...
    if dataset_name in [const.WATERBIRDS_NAME, const.CELEBA_NAME, const.PACS_NAME]:
        ...
        group_prompt_emb = get_text_embedding(group_prompt, text_encoder)
    ...
    for prompt in tqdm(z_reject):
        emb = get_text_embedding(prompt, text_encoder)
